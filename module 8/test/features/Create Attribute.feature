...
#     | role      | ADMIN                             |
  ...
  Scenario: 07 User creates new attribute
    ...
    Then I expect to be on [Manage Attributes] page
    And I expect "!Alex_mod8_autotest" attribute is shown on [Manage Attributes] page
    When I wait "success" notification is not displayed

  Scenario: 08 User deletes an attribute
    When I click "bin" icon for "!Alex_mod8_autotest" attribute on [Manage Attributes] page
    And I click "Yes" button
    Then I expect to be on [Manage Attributes] page
    And I expect "!Alex_mod8_autotest" attribute is not shown on [Manage Attributes] page